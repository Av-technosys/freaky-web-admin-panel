...
const Profile = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 mt-2  gap-3">
      {isPending ? (
        ...
        <>
          ...
          <Card className="col-span-1 lg:order-2  h-72  bg-white shadow-lg rounded-xl flex flex-col items-center text-center justify-center gap-4">
