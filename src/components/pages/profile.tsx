...
import {
  useGetUserInfoDetails,
  useUpdateUserDetails,
} from "../../services/useGetProfileInfo";
...
const Profile = () => {
  ...
  const { data: userData, isPending } = useGetUserInfoDetails();
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 mt-2 pr-2  gap-2">
      <>
        <Card className="col-span-1 order-2   lg:col-span-3  pb-2 bg-gray-50  rounded-xl">
          <CardHeader>
            <CardTitle className="text-lg text-[#111827s] font-bold">
          ...
          <div className="flex flex-col gap-6">
            {isPending ? (
              ...
              <>
                ...
                <CardFooter className="w-full flex items-center justify-end gap-3 ">
                  <Button
                    onClick={() => navigate("/forgot_password")}
                    variant={"outline"}
                    className=" px-6 border border-red-500 text-red-500 cursor-pointer"
                  >
                    Forgot Password
                  </Button>
                  <Button
        ...
        <Card className="col-span-1 lg:order-2  h-72  bg-gray-50  rounded-xl flex flex-col items-center text-center justify-center">
